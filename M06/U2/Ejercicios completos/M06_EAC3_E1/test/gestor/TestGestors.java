...
public class TestGestors {
    ...
    private  final String PU = "jpa2021s2";
     ...
     */
    @Test(expected=GestorException.class)
    public void provaModificarProducte88() throws GestorException{
        Producte a = (Producte) new ProducteElaborat(88,"###",true,0.0f );
        gestorProducte.modificar(a);
    }
    
    @Test
    public void provaConsultarProducte5() throws GestorException{
        Producte a=gestorProducte.obtenirProducte(5);
        assertTrue(compara(a,totsProductes.get(4),1));
    }

    @Test
    public void provaConsultarProducte88() throws GestorException{
    ...
    public void provaConsultarMPDeProducte() throws GestorException{
        assertTrue(comparaLlistes(gestorPE.obtenirMateriesPrimeresDelProducteElaborat(7),MPDeCroissant,1));
    } 

    @Test
    public void provaConsultarPEsAPartirDeMP() throws GestorException{
        assertTrue(comparaLlistes(gestorMP.obtenirProductesElaboratsAmbMateriaPrimera(2),PEAmbFarina,1));
    }
	...
	totsProductes.add(creaMP(1, "Llet", true, 2));
        ...
        crois.setMateriesPrimeres(new ArrayList<MateriaPrimera>(Arrays.asList(farina,ous)));
