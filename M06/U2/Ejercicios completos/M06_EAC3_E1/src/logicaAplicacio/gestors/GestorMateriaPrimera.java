...
public class GestorMateriaPrimera {
    ...
    public List<MateriaPrimera> obtenirMateriesPrimeres() {
       ...
       Query query = em.createQuery("SELECT m FROM MateriaPrimera m");
       List<MateriaPrimera> materias = query.getResultList();
       return materias;
    }
    ...
    public List<MateriaPrimera> obtenirMateriaPrimeraPerPrioritat(int prioritat) {
       //TODO completar el metode
       Query query = em.createQuery("SELECT m FROM MateriaPrimera m WHERE m.prio=:prioritat");
    ...
    public List<ProducteElaborat> obtenirProductesElaboratsAmbMateriaPrimera(int IdMat) {        
        //TODO completar el metode
        List<ProducteElaborat> productes = em.find(MateriaPrimera.class, IdMat).getProductesElaborats();
        return productes;
    }
    ...
    public void AugmentaPrioritatTotes(){
        //TODO completar el metode
        Query query = em.createQuery("UPDATE MateriaPrimera m SET m.prio=m.prio+1");
    }
